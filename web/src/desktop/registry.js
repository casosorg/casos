...
export const SYSTEM_APPS = [
  ...
  {key: "system-deployments", labelKey: "general:Deployments", icon: AppWindow, tint: "sky", path: "/deployments"},
  {key: "system-statefulsets", labelKey: "general:Stateful Sets", icon: Layers, tint: "teal", path: "/statefulsets"},
