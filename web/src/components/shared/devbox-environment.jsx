...
/**
 * Starting points for a workspace. Each is only an image and a setup script —
 * the editor is brought in beside the image by the backend, so these are the
 * images people already use, unmodified. The scripts install into the home
 * disk, since that is all that survives a restart.
 */
export const DEVBOX_PRESETS = [
  ...
  },
  {
    ...
    label: "Go",
    image: "golang:1.24",
    // The image's GOPATH is outside home, so modules would be fetched again on
    // every restart; go env -w writes into home and holds for the editor too.
